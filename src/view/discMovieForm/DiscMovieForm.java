 ...
 * @author Admin
 */
public class DiscMovieForm extends javax.swing.JFrame {
    ProductController productController;
    /**
     * Creates new form DiscMovieForm
     */
    public DiscMovieForm(String code,Employee employee) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean test= false;
        try {
            productController.addDiscMovie(name, code, purcharPrice, salePrice, remaining, productPlacement, genre, length, year, actor, director);
            test = true;
        } catch (Exception e) {
...
//            java.util.logging.Logger.getLogger(DiscMovieForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new DiscMovieForm().setVisible(true);
//            }
//        });
//    }
